...
def configure_matplotlib_for_ieee(style: str = 'single-column') -> None:
...
if __name__ == '__main__':
    # Configure for single-column layout; change to 'double-column' as needed
    configure_matplotlib_for_ieee('single-column')
    sample_plot()
    
    configure_matplotlib_for_ieee('double-column')
    sample_plot()
