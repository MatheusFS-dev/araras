...
def build_lm(
    ...
    ffn_dropout_rate_1_range: Union[float, tuple[float, float]] = (0.0, 0.3),
    ffn_dropout_rate_2_range: Union[float, tuple[float, float]] = (0.0, 0.3),
    num_heads_step: int = 1,
    key_dim_step: int = 1,
    ffn_multiplier_step: int = 1,
    attn_dropout_rate_step: float = 0.05,
    ffn_dropout_rate_1_step: float = 0.05,
    ffn_dropout_rate_2_step: float = 0.05,
    ...
    Args:
        ...
        attn_dropout_rate_range: Fixed dropout rate or inclusive range for the
            attention module.
        ffn_dropout_rate_1_range: Dropout specification for the first feed-forward
            dropout layer.
        ffn_dropout_rate_2_range: Dropout specification for the second
        ...
        ffn_dropout_rate_1_step: Step size for the first feed-forward dropout rate.
        ffn_dropout_rate_2_step: Step size for the second feed-forward dropout rate.
    ...
    if ffn_dropout_rate_1_step <= 0:
        raise ValueError("ffn_dropout_rate_1_step must be positive.")

    if ffn_dropout_rate_2_step <= 0:
        raise ValueError("ffn_dropout_rate_2_step must be positive.")
    ...
    ffn_dropout_rate_1 = _suggest_dropout_rate(
        trial,
        ffn_dropout_rate_1_range,
        ffn_dropout_rate_1_step,
        f"{name_prefix}_ffn_dropout_1",
    )

    ffn_dropout_rate_2 = _suggest_dropout_rate(
        trial,
        ffn_dropout_rate_2_range,
        ffn_dropout_rate_2_step,
