...
class FlagBasedRestartManager:
    ...
    def run_file_with_restart(
        ...
        if file_type == "notebook":
            print_process_status(f"Target file is a notebook: {validated_path.name}")
            print_process_status("Converting to Python file")
            try:
                ...
                file_type = "python"
                print_process_status(f"Converted notebook saved to: {validated_path.name}")
