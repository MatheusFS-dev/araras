"""Helper printing functions for the monitoring system."""
...
def print_monitoring_config_summary(
    ...
    """Display a summary of the monitoring configuration."""
    print()
    print("=" * 70)
...
def print_restart_info(restart_count: int, max_restarts: int, delay: float) -> None:
    """Print information about an upcoming restart."""
...
def print_cleanup_info(terminated: int, killed: int) -> None:
    """Print information about cleaned up child processes."""
