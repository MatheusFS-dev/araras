"""File type detection and command generation utilities."""
...
class FileTypeHandler:
    ...
    def build_execution_command(
        ...
        if cache_key in cls._command_cache:
            cached = cls._command_cache[cache_key]
            return cached.copy(), cls.get_file_type(file_path)
        ...
        if file_type == "python":
            ...
            raise ValueError(
                f"Unsupported file type: {file_type} for {file_path}"
            )
