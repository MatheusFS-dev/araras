"""
This module provides utilities for logging system and machine learning resource usage,
including CPU, RAM, GPU, CUDA, and TensorFlow memory statistics. The logging is performed
